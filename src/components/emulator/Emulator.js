...
const Emulator = () => {
    return (
        <div style={{ padding: '20px' }}>
            ...
            <Typography variant="body1">
                <h5>Mac -{'>'} <Link href="https://drive.google.com/file/d/1NB_ka_spyRtrNvRZyTA8ZCKNpzbgiGiz/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                    Baixe aqui de graça
                </Link></h5>
                
            </Typography>
            <Typography variant="body1">
                <h5>Linux -{'>'} <Link href="https://drive.google.com/file/d/1keDU0w68SfrhyE0gAkdAA9Qf-Rzzdrex/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                    Baixe aqui de graça
                </Link></h5>
